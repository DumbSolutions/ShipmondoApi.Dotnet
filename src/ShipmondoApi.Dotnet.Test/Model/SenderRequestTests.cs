...
namespace ShipmondoApi.Dotnet.Test.Model
{
    ...
    public class SenderRequestTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" SenderRequest
            //Assert.IsType<SenderRequest>(instance);
        }
