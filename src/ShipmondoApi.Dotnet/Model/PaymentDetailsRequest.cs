...
namespace ShipmondoApi.Dotnet.Model
{
    ...
    public partial class PaymentDetailsRequest : IEquatable<PaymentDetailsRequest>, IValidatableObject
    {
        ...
        /// <param name="amountIncludingVat">Total price including taxes of the sales order. (required).</param>
        /// <param name="authorizedAmount">The amount authorized by the payment gateway..</param>
        /// <param name="currencyCode">ISO 4217 currency code of the order total. (required).</param>
        /// <param name="vatAmount">Total amount of taxes for the order. (required).</param>
        ...
        public PaymentDetailsRequest(string amountExcludingVat = default(string), string amountIncludingVat = default(string), string authorizedAmount = default(string), string currencyCode = default(string), string vatAmount = default(string), string vatPercent = default(string), string paymentMethod = default(string), string transactionId = default(string), string paymentGatewayId = default(string))
        {
            // to ensure "amountIncludingVat" is required (not null)
            if (amountIncludingVat == null)
            {
                throw new ArgumentNullException("amountIncludingVat is a required property for PaymentDetailsRequest and cannot be null");
            }
            this.AmountIncludingVat = amountIncludingVat;
            // to ensure "currencyCode" is required (not null)
            if (currencyCode == null)
            {
                throw new ArgumentNullException("currencyCode is a required property for PaymentDetailsRequest and cannot be null");
            }
            this.CurrencyCode = currencyCode;
            // to ensure "vatAmount" is required (not null)
            if (vatAmount == null)
            {
                throw new ArgumentNullException("vatAmount is a required property for PaymentDetailsRequest and cannot be null");
            }
        ...
        [DataMember(Name = "amount_including_vat", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "vat_amount", IsRequired = true, EmitDefaultValue = true)]
