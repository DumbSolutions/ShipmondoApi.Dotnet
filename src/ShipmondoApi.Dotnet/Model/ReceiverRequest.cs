...
namespace ShipmondoApi.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReceiverRequest")]
    public partial class ReceiverRequest : IEquatable<ReceiverRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceiverRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReceiverRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceiverRequest" /> class.
        /// </summary>
        ...
        /// <param name="countryCode">ISO 3166-1 alpha-2 country code of the receiver address. (required).</param>
        /// <param name="vatId">Special VAT idenfication number; for example, GB EORI for Great Britain..</param>
        ...
        public ReceiverRequest(string name = default(string), string attention = default(string), string address1 = default(string), string address2 = default(string), string zipcode = default(string), string city = default(string), string countryCode = default(string), string vatId = default(string), string email = default(string), string mobile = default(string), string telephone = default(string), string instruction = default(string), DateTime? date = default(DateTime?), string fromTime = default(string), string toTime = default(string), string memberId = default(string), string accessCode = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ReceiverRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "address1" is required (not null)
            if (address1 == null)
            {
                throw new ArgumentNullException("address1 is a required property for ReceiverRequest and cannot be null");
            }
            this.Address1 = address1;
            // to ensure "zipcode" is required (not null)
            if (zipcode == null)
            {
                throw new ArgumentNullException("zipcode is a required property for ReceiverRequest and cannot be null");
            }
            this.Zipcode = zipcode;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for ReceiverRequest and cannot be null");
            }
            this.City = city;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for ReceiverRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Special VAT idenfication number; for example, GB EORI for Great Britain.</value>
        /// <example>&quot;GB018384932372&quot;</example>
        ...
        /// </summary>
        /// <value>Carrier member ID. Some products support/require this; e.g., DHL Parcel shipments to Packstations (DHL PostNumber).</value>
        ...
        /// </summary>
        /// <value>Gate/door code for the carrier to access the receiver&#39;s address.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReceiverRequest {\n");
        ...
        {
            return this.Equals(input as ReceiverRequest);
        }

        /// <summary>
        /// Returns true if ReceiverRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ReceiverRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReceiverRequest input)
        {
            if (input == null)
            {
                return false;
