...
namespace ShipmondoApi.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SalesOrderShipToRequest")]
    public partial class SalesOrderShipToRequest : IEquatable<SalesOrderShipToRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesOrderShipToRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SalesOrderShipToRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesOrderShipToRequest" /> class.
        /// </summary>
        ...
        public SalesOrderShipToRequest(string name = default(string), string attention = default(string), string address1 = default(string), string address2 = default(string), string zipcode = default(string), string city = default(string), string countryCode = default(string), string email = default(string), string mobile = default(string), string telephone = default(string), string instruction = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for SalesOrderShipToRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "address1" is required (not null)
            if (address1 == null)
            {
                throw new ArgumentNullException("address1 is a required property for SalesOrderShipToRequest and cannot be null");
            }
            this.Address1 = address1;
            // to ensure "zipcode" is required (not null)
            if (zipcode == null)
            {
                throw new ArgumentNullException("zipcode is a required property for SalesOrderShipToRequest and cannot be null");
            }
            this.Zipcode = zipcode;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for SalesOrderShipToRequest and cannot be null");
            }
            this.City = city;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for SalesOrderShipToRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SalesOrderShipToRequest {\n");
        ...
        {
            return this.Equals(input as SalesOrderShipToRequest);
        }

        /// <summary>
        /// Returns true if SalesOrderShipToRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SalesOrderShipToRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesOrderShipToRequest input)
        {
            if (input == null)
            {
                return false;
