...
namespace ShipmondoApi.Dotnet.Model
{
    ...
    public partial class Item : IEquatable<Item>, IValidatableObject
    {
        ...
        /// <param name="sku">SKU (stock keeping unit). Must be unique for every item, including variants..</param>
