...
namespace ShipmondoApi.Dotnet.Model
{
    ...
    public partial class Sender : IEquatable<Sender>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="name">Name of the sender. Can be either a company name or the name of a private person..</param>
        /// <param name="attention">Attention of the sender. If the sender is a company, it is the contact person..</param>
        /// <param name="address1">Address of the sender, including address number..</param>
        /// <param name="address2">address2.</param>
        /// <param name="zipcode">Zip code of the address..</param>
        /// <param name="city">Name of the city that the zip code refers to..</param>
        /// <param name="countryCode">ISO 3166-1 alpha-2 country code of the sender..</param>
        ...
        public Sender(string name = default(string), string attention = default(string), string address1 = default(string), string address2 = default(string), string zipcode = default(string), string city = default(string), string countryCode = default(string), string email = default(string), string mobile = default(string), string telephone = default(string))
        {
            this.Name = name;
