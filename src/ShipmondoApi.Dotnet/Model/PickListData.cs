...
namespace ShipmondoApi.Dotnet.Model
{
    ...
    /// PickListData
    /// </summary>
    [DataContract(Name = "PickListData")]
    public partial class PickListData : IEquatable<PickListData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PickListData" /> class.
        /// </summary>
        /// <param name="base64">Data encoded in Base64 format..</param>
        /// <param name="fileFormat">File format for the returned PDF data..</param>
        public PickListData(string base64 = default(string), string fileFormat = default(string))
        {
            this.Base64 = base64;
        ...
        {
            return this.Equals(input as PickListData);
        }

        /// <summary>
        /// Returns true if PickListData instances are equal
        /// </summary>
        /// <param name="input">Instance of PickListData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PickListData input)
        {
            if (input == null)
            {
                return false;
