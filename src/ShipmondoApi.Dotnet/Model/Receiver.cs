...
namespace ShipmondoApi.Dotnet.Model
{
    ...
    public partial class Receiver : IEquatable<Receiver>, IValidatableObject
    {
        ...
        public Receiver(string name = default(string), string attention = default(string), string address1 = default(string), string address2 = default(string), string zipcode = default(string), string city = default(string), string countryCode = default(string), string email = default(string), string mobile = default(string), string telephone = default(string), string instruction = default(string))
        {
            this.Name = name;
