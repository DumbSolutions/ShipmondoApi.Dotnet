...
namespace ShipmondoApi.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SenderRequest")]
    public partial class SenderRequest : IEquatable<SenderRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SenderRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SenderRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SenderRequest" /> class.
        /// </summary>
        ...
        /// <param name="countryCode">ISO 3166-1 alpha-2 country code of the sender. (required).</param>
        /// <param name="vatId">Special VAT idenfication number; for example, GB EORI for Great Britain or VOEC for Norway..</param>
        ...
        public SenderRequest(string name = default(string), string attention = default(string), string address1 = default(string), string address2 = default(string), string zipcode = default(string), string city = default(string), string countryCode = default(string), string vatId = default(string), string email = default(string), string mobile = default(string), string telephone = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for SenderRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "address1" is required (not null)
            if (address1 == null)
            {
                throw new ArgumentNullException("address1 is a required property for SenderRequest and cannot be null");
            }
            this.Address1 = address1;
            // to ensure "zipcode" is required (not null)
            if (zipcode == null)
            {
                throw new ArgumentNullException("zipcode is a required property for SenderRequest and cannot be null");
            }
            this.Zipcode = zipcode;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for SenderRequest and cannot be null");
            }
            this.City = city;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for SenderRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>ISO 3166-1 alpha-2 country code of the sender.</value>
        /// <example>&quot;DK&quot;</example>
        ...
        /// </summary>
        /// <value>Special VAT idenfication number; for example, GB EORI for Great Britain or VOEC for Norway.</value>
        ...
        {
            return this.Equals(input as SenderRequest);
        }

        /// <summary>
        /// Returns true if SenderRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SenderRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SenderRequest input)
        {
            if (input == null)
            {
                return false;
