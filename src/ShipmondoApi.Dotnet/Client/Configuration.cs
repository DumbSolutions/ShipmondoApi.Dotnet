...
namespace ShipmondoApi.Dotnet.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("DumbSolutions.ShipmondoApi.Dotnet/1.0.3");
        ...
        public Configuration(
            ...
            string basePath = "https://app.shipmondo.com/api/public/v3") : this()
        {
        ...
        {
            string report = "C# SDK (ShipmondoApi.Dotnet) Debug Report:\n";
